...
contractAddresses = [
    ...
    const eventsList = ['OwnershipTransferred','BaseURIset','AdventureKeyMade','AdventureWhitelistUpdated','ExchangeAddedToWhitelist','ExchangeRemovedFromWhitelist','BatchMetadataUpdate'];
